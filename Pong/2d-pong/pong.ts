...
let playerOneVelocity: number = 0;
let playerTwoVelocity: number = 0;
...
function ballWallCollision(): void {
    function paddleCollision(paddle: GameElement): boolean {
